...
export function AccordianItem({children, value, trigger, index, ...props}) {
	...
	return (
		<li className="border-b bg-transparent text-white" {...props}>
			<header
				role="button"
			...
			>
				<div className="flex items-baseline gap-5 mt-1">
					<p className="font-bold text-3xl">{index}</p>
